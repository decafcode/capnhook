...
static BOOL WSAAPI iohook_closesocket(SOCKET s);
...
static const struct hook_symbol iohook_ws2_32_syms[] = {
    {
        .name       = "socket",
        .ordinal    = 23,
        .patch      = iohook_socket,
...
HRESULT iohook_invoke_real_closesocket(struct irp *irp)
{
    ...
    ok = next_closesocket((SOCKET) irp->fd);
